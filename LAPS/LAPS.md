...
Esta guía técnica ofrece los pasos fundamentales para implementar **L**ocal **A**dministrator **P**assword **S**olution o sus siglas en ingles LAPS.
  ...
  * [Configuración de permisos](#configuraci%C3%B3n-de-permisos)
    + [Acceso por grupo(s) de dominio](#acceso-por-grupos-de-dominio)
  * [Política de Dominio para Configuración LAPS](#pol%C3%ADtica-de-dominio-para-configuraci%C3%B3n-laps)
    + [Configuración de Política para Computadora](#configuraci%C3%B3n-de-pol%C3%ADtica-para-computadora)
    + [Configuración de Política para Servidores](#configuraci%C3%B3n-de-pol%C3%ADtica-para-servidores)
  * [Comprobación de Configuración](#comprobaci%C3%B3n-de-configuraci%C3%B3n)
  * [Acrónimos](#acr-nimos)
